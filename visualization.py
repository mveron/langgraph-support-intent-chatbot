...
EDGES = (
    ...
    '"assess_ticket_need" -> "load_ticket_database" [label=" create_ticket"]',
    '"assess_ticket_need" -> "billing_support" [label=" respond_only billing"]',
    '"assess_ticket_need" -> "technical_support" [label=" respond_only technical"]',
    '"assess_ticket_need" -> "account_support" [label=" respond_only account"]',
    '"load_ticket_database" -> "create_ticket" [label=" create"]',
    '"load_ticket_database" -> "lookup_ticket_status" [label=" lookup"]',
    '"create_ticket" -> "billing_support" [label=" billing"]',
    '"create_ticket" -> "technical_support" [label=" technical"]',
    '"create_ticket" -> "account_support" [label=" account"]',
    '"billing_support" -> "END"',
